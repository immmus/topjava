...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.ALL_BETWEEN, query = "SELECT m FROM Meal m WHERE m.user.id=:userId AND m.dateTime" +
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String ALL_BETWEEN = "Meal.getAllSortedBetween";
