...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2018, Month.OCTOBER, 31, 10, 0), "Завтрак", 1000),
            new Meal(LocalDateTime.of(2018, Month.OCTOBER, 31, 13, 0), "Обед", 500),
            new Meal(LocalDateTime.of(2018, Month.OCTOBER, 31, 20, 0), "Ужин", 510)
    );
