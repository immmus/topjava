...
public class UserMealsUtil {
    public static void main(String[] args) {
        ...
        getFilteredWithExceeded(mealList, LocalTime.of(10, 0), LocalTime.of(21, 59), 2000)
    ...
    public static List<UserMealWithExceed> getFilteredWithExceeded
        ...
        /*mealList.stream().collect(
                Collectors.collectingAndThen(
                        Collectors.groupingBy(
                                ...
                                Collectors.summingInt(UserMeal::getCalories)), map ->map.keySet().stream()))*/
        return mealList.stream().filter(
                ...
                .map(meal -> new UserMealWithExceed(
                        ...
                        meal.getDescription(),
                        meal.getCalories(),
                        mapDayCalories.get(meal.getLocalDate()) <= caloriesPerDay)
