...
/**
 * Оставил как пример реализации с абстрактным классом
 * Так же можно сделать через Java Config:
...
public abstract class OldJdbcMealRepositoryImpl<T> implements MealRepository {
    ...
    @Autowired
    public OldJdbcMealRepositoryImpl(JdbcTemplate jdbcTemplate, NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
   ...
   // @Repository
    ...
    public static class Java8JdbcMealRepositoryImpl extends OldJdbcMealRepositoryImpl<LocalDateTime> {
   ...
   // @Repository
    ...
    public static class TimestampJdbcMealRepositoryImpl extends OldJdbcMealRepositoryImpl<Timestamp> {
