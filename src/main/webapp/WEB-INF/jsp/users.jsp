        ...
        <table class="table table-striped" id="datatable">
            ...
            <c:forEach items="${users}" var="user">
                ...
                <tr>
                    ...
                    <td>${user.roles}</td>
                    <td><input class="enableOrDisable" name="enableOrDisable" type="checkbox"
                               <c:if test="${user.enabled}">checked</c:if> onchange="enableOrDisable(${user.id}, $(this))"/></td>
                ...
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name"
                               placeholder="<spring:message code="user.name"/>" required>
                    </div>

                    <div class="form-group">
                        <label for="email" class="col-form-label"><spring:message code="user.email"/></label>
                        <input type="email" class="form-control" id="email" name="email"
                               placeholder="<spring:message code="user.email"/>" required>
                    </div>
